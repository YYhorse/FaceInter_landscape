 ...
 */
package com.baiduface.www.Utils.Widget;
...
public class WaveView extends View {
    ...
    private static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#28A1CF49");
    private static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3CA1CF49");
