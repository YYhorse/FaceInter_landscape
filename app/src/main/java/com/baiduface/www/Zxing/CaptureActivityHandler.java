...
package com.baiduface.www.Zxing;
...
import com.baiduface.www.Activity.ScanPayDialog;
...
public final class CaptureActivityHandler extends Handler {
  ...
  private final ScanPayDialog activity;
  ...
  public CaptureActivityHandler(ScanPayDialog activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case MessageIDs.launch_product_query:
        ...
        activity.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);      //跳转动画  淡出淡入
        break;
    }
  }
